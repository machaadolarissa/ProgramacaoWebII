...
namespace Larissa_Machado_Projeto1.Areas.Identity.Pages.Account
{
    public class RegisterModelNutricionista : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            var planosDisponiveis = _context.TbPlano
                .Where(p => p.Nome == "NutricionalTotal" || p.Nome == "NutricionalParcial")
                .ToList();

            ViewData["IdPlano"] = new SelectList(planosDisponiveis, "IdPlano", "Nome");
